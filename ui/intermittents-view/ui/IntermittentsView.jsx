...
class IntermittentsView extends React.Component {
  ...
  componentDidMount() {
    const { graphs, from, to, tree, fetchData, location, history } = this.props;
    const params = parseQueryParams(location.search);

    // if there are user defined query params in the URL, update the data
    // otherwise, set the params based on the default props
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (location.search !== this.props.location.search) {
      console.log(location.search, history);
